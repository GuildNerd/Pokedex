...
export default function TypeDisplay({typeName, icon}:TypeDisplayProps) {

    const colorName = 'bg-'+ typeName;
    console.log(colorName);
    const className = ['flex-1', 'border-black', 'border-2', 'rounded-md', 'p-2', colorName].join(' ');
